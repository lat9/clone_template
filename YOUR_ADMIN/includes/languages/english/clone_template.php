...
//
if (!defined ('CLONE_TEMPLATE_VERSION')) define ('CLONE_TEMPLATE_VERSION', 'v1.1.0');
define ('HEADING_TITLE', 'Clone a Template <span style="font-size: smaller;">(' . CLONE_TEMPLATE_VERSION . ')</span>');
define ('TEXT_INSTRUCTIONS', 'This tool enables you to &quot;clone&quot; an <em>existing</em> template for your store.  When a template is &quot;cloned&quot;, all <em>template-override</em> files associated with the source template are copied to folders for the new template and entries for the source template\'s <b>Layout Boxes Controller</b> settings are copied to for the new template.<br /><br />The value you enter in the <b>Target Template Display Name</b> field will be used to identify the new template in your <strong>Tools-&gt;Template Selection</strong> tool.');
